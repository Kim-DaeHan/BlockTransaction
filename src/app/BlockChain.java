...
public class BlockChain {
	...
	public static void main(String[] args) {
		...
		// create genesis transaction, which sends 100 NoobCoin to Alice:
		...
		UTXOs.put(genesisTransaction.outputs.get(0).id, genesisTransaction.outputs.get(0)); // its important to store our
	...
	public static Boolean isChainValid() {
		...
		HashMap<String, TransactionOutput> tempUTXOs = new HashMap<String, TransactionOutput>(); // a temporary working list
																																															// of unspent transactions
																																															// at a given block state.
